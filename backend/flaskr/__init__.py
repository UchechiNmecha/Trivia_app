...
def create_app(test_config=None):
    ...
    def get_categories():
        ...
        categories_data = {category.id: category.type for category in categories}
    ...
    def search_questions():
        ...
        by_question = Question.question.ilike(search_query)
        
        try:
            results = Question.query.order_by(Question.id).filter(by_question).all()
    ...
    def get_quizzes():
        ...
        try:
            ...
            if questions not in previous_questions:
